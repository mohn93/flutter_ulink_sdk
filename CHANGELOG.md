...
- Raise the Android build toolchain to clear Flutter 3.44's "will soon be dropped" notices: AGP 8.7.3 → 8.11.1 (plugin buildscript + example), Gradle 8.12 → 8.14 (example wrapper), Kotlin 2.1.0 → 2.2.20 (example). Verified building the example release bundle on Flutter 3.44.1.

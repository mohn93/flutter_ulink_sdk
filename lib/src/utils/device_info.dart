...
class DeviceInfoHelper {
  ...
  static Future<Map<String, dynamic>> getBasicDeviceInfo() async {
    ...
    try {
      ...
      if (kIsWeb) {
        ...
        deviceData['systemMemoryInMegabytes'] = windowsInfo.systemMemoryInMegabytes.toString();
  ...
  static Future<Map<String, dynamic>> getCompleteDeviceInfo([BuildContext? context]) async {
